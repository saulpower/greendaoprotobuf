 ...
 */
public class Clasz extends SyncBase  {
    ...
    Clasz(String guid, String name, String externalID, String tagString, Long tenantID, Integer studentsPerTeacher, long saveResultSaveResultId, String dateLastModified, Long syncBaseId, Boolean isDeleted, Integer version, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
    ...
    public Clasz(String guid, String name, String externalID, String tagString, Long tenantID, Integer studentsPerTeacher, long saveResultSaveResultId, String dateLastModified, Boolean isDeleted, Integer version, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
        this.externalID = externalID;
        this.tagString = tagString;
