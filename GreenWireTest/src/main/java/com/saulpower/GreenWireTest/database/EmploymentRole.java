...
/**
 * Entity mapped to table EMPLOYMENT_ROLE.
 */
public class EmploymentRole extends SyncBase  {

    private transient long employmentRolesOUId;
    ...
    private transient long employmentRolesCenterId;
    ...
    private transient EmploymentRoleDao myDao;
    private OU oU;
    ...
    public EmploymentRole(Long id) {
        this.id = id;
        setDerivedEntityType(getClass().getCanonicalName());
    }

    EmploymentRole(long employmentRolesOUId, String externalID, String guid, String name, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, long employmentRolesCenterId, Long syncBaseId, Boolean isDeleted, Integer version, Long id, long oUOUId, String dateCreated, Boolean isActive) {
        this.employmentRolesOUId = employmentRolesOUId;
        ...
        this.employmentRolesCenterId = employmentRolesCenterId;
    ...
    public EmploymentRole(long employmentRolesOUId, String externalID, String guid, String name, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, long employmentRolesCenterId, Boolean isDeleted, Integer version, Long id, long oUOUId, String dateCreated, Boolean isActive) {
        this.employmentRolesOUId = employmentRolesOUId;
        this.externalID = externalID;
        this.guid = guid;
        this.name = name;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getEmploymentRoleDao() : null;
    }

    public long getEmploymentRolesOUId() {
        return employmentRolesOUId;
    }

    public void setEmploymentRolesOUId(long employmentRolesOUId) {
        this.employmentRolesOUId = employmentRolesOUId;
    }
    ...
    public long getEmploymentRolesCenterId() {
        return employmentRolesCenterId;
    }

    public void setEmploymentRolesCenterId(long employmentRolesCenterId) {
        this.employmentRolesCenterId = employmentRolesCenterId;
    }
    ...
    public List<CustomValue> getCustomValues() {
        if (customValues == null) {
            ...
            List<CustomValue> customValuesNew = targetDao._queryEmploymentRole_CustomValues(id);
            synchronized (this) {
                if(customValues == null) {
