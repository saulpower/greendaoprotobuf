...
public class Association {
    ...
    public Association(String externalID, String guid, String name, String tagString, String roleID, long roleRoleBaseId, Long tenantID, long saveResultSaveResultId, Long dateLastModified, long associationsOUId, long associationsOUBaseId, long associationsStudentId, long userAuthorizedPersonId, long associationsPersonId, Boolean isDeleted, Integer version, long associationsAuthorizedPersonId, Long id, long oUOUBaseId, Long dateCreated, Boolean isActive) {
