...
public class School {
    ...
    public School(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, Long dateLastModified, long phoneNumberPhoneNumberId, Boolean isDeleted, Integer version, Long id, long addressAddressId, long oUOUId, Long dateCreated) {
        this.guid = guid;
        this.name = name;
