...
public class PersonalRelationship {
    ...
    public PersonalRelationship(String externalID, String name, String guid, String fromPersonID, String toPersonID, String tagString, Boolean isEmergencyContact, long fromPersonPersonId, Long tenantID, long saveResultSaveResultId, Long dateLastModified, long peopleFamilyId, Boolean isPickupOK, long relationshipsStudentId, RelationshipType relationshipType, Boolean isBillingPerson, Boolean isDeleted, Integer version, Boolean showInPickupList, Long id, Boolean isLegalGuardian, Long dateCreated, long relationshipsPersonId, long toPersonPersonId) {
