...
public class RoleBase {
    ...
    public RoleBase(String externalID, String guid, String name, Boolean canManageOUs, Boolean isService, String tagString, Long tenantID, long saveResultSaveResultId, Long dateLastModified, Boolean isManager, Boolean isDeleted, Integer version, Boolean isAdmin, Long id, long rolesOUId, Long dateCreated, Boolean canManageUsers, Boolean isSales, Boolean isActive, long rolesOUBaseId) {
