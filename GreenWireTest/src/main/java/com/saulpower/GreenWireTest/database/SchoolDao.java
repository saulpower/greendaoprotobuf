    ...
    */
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T1", daoSession.getOUDao().getAllColumns());
            builder.append(',');
            SqlUtils.appendColumns(builder, "T2", daoSession.getAddressDao().getAllColumns());
            builder.append(',');
            SqlUtils.appendColumns(builder, "T3", daoSession.getSaveResultDao().getAllColumns());
            builder.append(" FROM SCHOOL T");
            builder.append(" LEFT JOIN PHONE_NUMBER T0 ON T.'PHONE_NUMBER_PHONE_NUMBER_ID'=T0.'_id'");
            builder.append(" LEFT JOIN OU T1 ON T.'O_UOUID'=T1.'_id'");
            builder.append(" LEFT JOIN ADDRESS T2 ON T.'ADDRESS_ADDRESS_ID'=T2.'_id'");
