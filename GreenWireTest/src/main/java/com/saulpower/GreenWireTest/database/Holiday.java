...
public class Holiday {
    ...
    public Holiday(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, Long dateLastModified, Boolean isDeleted, Long startDate, Integer version, Long id, long holidaysOUId, long oUOUId, Long dateCreated, Long endDate) {
        this.guid = guid;
        this.name = name;
