...
public class OU {
    ...
    public OU(String externalID, String guid, String name, long parentOUBaseId, String tagString, String stateTaxID, Long tenantID, long saveResultSaveResultId, Long dateLastModified, String number, long oUTypeOUTypeId, Boolean isDeleted, String federalTaxID, Integer version, Long id, String parentID, Long dateCreated, Boolean isActive) {
