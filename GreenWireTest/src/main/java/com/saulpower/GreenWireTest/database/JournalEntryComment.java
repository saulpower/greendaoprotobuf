...
/**
 * Entity mapped to table JOURNAL_ENTRY_COMMENT.
 */
public class JournalEntryComment extends SyncBase  {

    private String guid;
    private String name;
    private String externalID;
    private String tagString;
    private transient long commentsJournalEntryId;
    ...
    private transient JournalEntryCommentDao myDao;
    ...
    public JournalEntryComment(Long id) {
        this.id = id;
        setDerivedEntityType(getClass().getCanonicalName());
    }

    JournalEntryComment(String guid, String name, String externalID, String tagString, long commentsJournalEntryId, Long tenantID, long saveResultSaveResultId, String dateLastModified, Long syncBaseId, Boolean isDeleted, Integer version, String content, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
        this.externalID = externalID;
        this.tagString = tagString;
        this.commentsJournalEntryId = commentsJournalEntryId;
    ...
    public JournalEntryComment(String guid, String name, String externalID, String tagString, long commentsJournalEntryId, Long tenantID, long saveResultSaveResultId, String dateLastModified, Boolean isDeleted, Integer version, String content, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
        this.externalID = externalID;
        this.tagString = tagString;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getJournalEntryCommentDao() : null;
    }
    ...
    public long getCommentsJournalEntryId() {
        return commentsJournalEntryId;
    }

    public void setCommentsJournalEntryId(long commentsJournalEntryId) {
        this.commentsJournalEntryId = commentsJournalEntryId;
    }
    ...
    public List<CustomValue> getCustomValues() {
        if (customValues == null) {
            ...
            List<CustomValue> customValuesNew = targetDao._queryJournalEntryComment_CustomValues(id);
            synchronized (this) {
                if(customValues == null) {
