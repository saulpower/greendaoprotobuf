 ...
 */
public class JournalEntryComment {
    ...
    public JournalEntryComment(String guid, String name, String externalID, String tagString, long commentsJournalEntryId, Long tenantID, long saveResultSaveResultId, Long dateLastModified, Boolean isDeleted, Integer version, String content, Long id, Long dateCreated) {
        this.guid = guid;
        this.name = name;
