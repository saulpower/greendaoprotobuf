...
public class OUType {
    ...
    public OUType(Boolean isCenter, String externalID, Boolean isDeleted, String name, String guid, Integer version, String tagString, Long id, Long dateCreated, Long tenantID, long saveResultSaveResultId, Long dateLastModified) {
