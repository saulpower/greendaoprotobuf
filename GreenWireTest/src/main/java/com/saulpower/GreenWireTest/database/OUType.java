...
/**
 * Entity mapped to table OUTYPE.
 */
public class OUType extends SyncBase  {
    ...
    private transient OUTypeDao myDao;
    ...
    public OUType(Long id) {
        this.id = id;
        setDerivedEntityType(getClass().getCanonicalName());
    }

    OUType(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, Long syncBaseId, Boolean isCenter, Boolean isDeleted, Integer version, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
    ...
    public OUType(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, Boolean isCenter, Boolean isDeleted, Integer version, Long id, String dateCreated) {
        this.guid = guid;
        this.name = name;
        this.externalID = externalID;
        this.tagString = tagString;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getOUTypeDao() : null;
    }
    ...
    public List<CustomValue> getCustomValues() {
        if (customValues == null) {
            ...
            List<CustomValue> customValuesNew = targetDao._queryOUType_CustomValues(id);
            synchronized (this) {
                if(customValues == null) {
