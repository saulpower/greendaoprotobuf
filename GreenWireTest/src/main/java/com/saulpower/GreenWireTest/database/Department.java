...
public class Department {
    ...
    public Department(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, Long dateLastModified, Boolean isDeleted, Integer version, long departmentsEmployeeFileId, Long id, long oUOUId, Long dateCreated, long departmentsOUId, Boolean isActive) {
        this.guid = guid;
        this.name = name;
