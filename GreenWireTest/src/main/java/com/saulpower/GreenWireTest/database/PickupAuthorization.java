...
public class PickupAuthorization {
    ...
    public PickupAuthorization(String externalID, String guid, String name, long pickupListStudentId, String tagString, long authorizedPickupsStudentId, Long tenantID, long saveResultSaveResultId, long authorizedPickupsPersonId, Long dateLastModified, Boolean isDeleted, Integer version, Long startDate, Long id, Long dateCreated, Boolean requiresConfirmation, Boolean isActive, String notes, Long endDate) {
