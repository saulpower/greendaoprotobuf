...
public class Device {
    ...
    public Device(String guid, String name, String externalID, String tagString, String uUID, Long tenantID, long saveResultSaveResultId, Long dateLastModified, String model, Boolean isDeleted, Integer version, String sytemVersion, Long id, String systemName, Long dateCreated) {
        this.guid = guid;
        this.name = name;
