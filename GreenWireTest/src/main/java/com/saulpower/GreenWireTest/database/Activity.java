...
public class Activity extends SyncBase  {
    ...
    Activity(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, Long syncBaseId, Boolean isDeleted, Integer version, Long id, long activitiesStudentId, String dateCreated) {
        this.guid = guid;
        this.name = name;
    ...
    public Activity(String guid, String name, String externalID, String tagString, Long tenantID, long saveResultSaveResultId, String dateLastModified, Boolean isDeleted, Integer version, Long id, long activitiesStudentId, String dateCreated) {
        this.guid = guid;
        this.name = name;
        this.externalID = externalID;
        this.tagString = tagString;
