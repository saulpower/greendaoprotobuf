...
public class PhoneNumberDao extends AbstractDao<PhoneNumber, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Type = new Property(3, PhoneType.class, "type", false, "TYPE");
    };
    ...
    public PhoneNumber readEntity(Cursor cursor, int offset) {
        PhoneNumber entity = new PhoneNumber( //
            ...
            cursor.isNull(offset + 3) ? null : PhoneType.fromInt(cursor.getLong(offset + 3)) // type
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PhoneNumber entity, int offset) {
        ...
        entity.setType(cursor.isNull(offset + 3) ? null : PhoneType.fromInt(cursor.getLong(offset + 3)));
     }
